...
class Controller(Node):
    ...
    def __init__(self, name):
        ...
        elif self.machine_type == 'MentorPi_Tank':
            self.mecanum = mecanum.MecanumChassis(wheelbase=0.1368, track_width=0.1581, wheel_diameter=0.055)
    ...
    def cal_odom_fun(self):
        ...
        self.get_logger().info('\033[1;32mcal_odom_fun linear_factor: %f\033[0m' % self.linear_factor)
