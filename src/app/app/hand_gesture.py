...
class HandGestureControlNode(Node):
    def __init__(self, name):
        ...
        self.get_logger().info('\033[1;32m%s\033[0m' % self.machine_type)
    ...
    def enter_srv_callback(self, request, response):
        ...
        set_servo_position(self.joints_pub, 1.5, ((10, 700), (5, 500), (4, 600), (3, 0), (2, 750), (1, 500)))
        response.success = True
                ...
                if 'Acker' in self.machine_type:
                    ...
                    if 'Mecanum' in self.machine_type:
                        ...
                        if twist.angular.z == 0:
                            ...
                            t_start = current_time + 1.31 * math.pi / self.angular_speed
                         
                    self.get_logger().info('\033[1;32m%s\033[0m' % twist )
                    self.mecanum_pub.publish(twist)
