    ...
    def enter_srv_callback(self, request, response):
        ...
        with self.lock:
            ...
            if self.camera_info_sub is None:
                self.camera_info_sub = self.create_subscription(CameraInfo, '/ascamera/camera_publisher/rgb0/camera_info', self.camera_info_callback, 1) # 订阅摄像头信息(subscribe to the camera information)

        
            set_servo_position(self.joints_pub, 1, ((10, 600), (5, 500), (4, 220), (3, 100), (2, 665), (1, 500)))
        response.success = True
